...
REQUIREMENT_COMPLETENESS_AUDITOR = load_prompt_template("requirement_completeness_auditor.md")
CONVERSATIONAL_VALIDATOR = load_prompt_template("conversational_validator.md")
